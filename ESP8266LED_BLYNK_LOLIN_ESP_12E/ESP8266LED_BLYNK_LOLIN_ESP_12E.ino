      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(".head { position: fixed; left: 0; top: 0; width: 100%; background-color: red; font-size:35px; font-weight: bold; color: white; text-align: center; }");
            client.println(".footer { position: fixed; left: 0; bottom: 0; background-color: red; width: 100%; color: white; text-align: center;}");
            ...
            // Web Page Heading
            client.println("<div class=\"head\"> <p> AKILA GEETHANJANA </p> </div></br></br></br></br></br></br></br>");
